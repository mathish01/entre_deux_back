...
export class TagController {
    ...
    static async createTag (req: AuthenticatedRequest & { body: CreateTagRequest }, res: Response<ApiResponse<TagWithRelations>>) {
        try {
            const { name } = req.body;
    ...
    static async getAllTags(req: AuthenticatedRequest, res: Response<ApiResponse<TagWithRelations[]>>) {
        try {
    ...
    static async getTagNames(req: AuthenticatedRequest, res: Response<ApiResponse<string[]>>) {
        try {
            const tags = await prisma.references_tags.findMany({
                select: {
                    name: true
    ...
    static async addTagToPost(req: AuthenticatedRequest & { params: TagParams; body: AddTagToPostRequest }, res: Response<ApiResponse<any>>) {
        try {
    ...
    static async getPostTags(req: AuthenticatedRequest & { params: TagParams }, res: Response<ApiResponse<any[]>>) {
        try {
            const { postId } = req.params;
    ...
    static async removeTagFromPost(req: AuthenticatedRequest & { params: TagParams }, res: Response<ApiResponse<void>>) {
        try {
    ...
    static async searchPostsByTag(req: AuthenticatedRequest & { query: SearchRequest }, res: Response<ApiResponse<PostWithRelations[]>>) {
        try {
            const { q } = req.query;
    ...
    static async getPostsByTagName(req: AuthenticatedRequest & { params: TagParams }, res: Response<ApiResponse<PostWithRelations[]>>) {
        try {
